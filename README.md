...
<p>O Intuito da aplicação mobile, ou seja, deste projeto é listar casos cadastrados no banco anteriormente por ONGs cadastradas, através do cliente web. Esses casos possuem detalhes sobre o ocorrido, valor solicitado pela ONG e contato para que o usuário do app possa ajudar/doar para o caso selecionado.</p>
